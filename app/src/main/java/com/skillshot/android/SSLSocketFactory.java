...
public class SSLSocketFactory implements LayeredSocketFactory {
    ...
    public SSLSocketFactory(boolean isConnectingToGoinoutServer) {
   ...
   /* private static SSLContext createEasySSLContext() throws IOException {
        try {
        	...
        	InputStream clientStream = MCQApplication.getInstance().getApplicationContext().getResources().openRawResource(R.raw.production_test_client);
	        ...
	        instream = MCQApplication.getInstance().getApplicationContext().getResources().openRawResource(R.raw.production_test_ca);
